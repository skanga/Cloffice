 ...
 * Keeps the desktop bridge type surface on `window.cloffice` as the
 * primary desktop bridge surface.
 */
interface Window {
  cloffice?: {
    getConfig: () => Promise<any>;
    saveConfig: (config: { endpointUrl: string; accessToken: string }) => Promise<any>;
    ...
    debugBuildInternalCoworkPrompt: (payload: any) => Promise<any>;
