...
const CATEGORY_CONFIG = {
  'about-me': { icon: User, label: 'Über mich', color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-950/30' },
  rules: { icon: BookOpen, label: 'Regeln', color: 'text-amber-600', bg: 'bg-amber-50 dark:bg-amber-950/30' },
  knowledge: { icon: Brain, label: 'Wissen', color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-950/30' },
  reflection: { icon: Sparkles, label: 'Reflexion', color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-950/30' },
} as const;
      ...
      <header className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 font-sans text-sm text-muted-foreground">
            Persönliches Wissen, Regeln und Reflexionen — dein Agent lernt kontinuierlich.
          </p>
        </div>
        <Button
          type="button"
        ...
        >
          ...
          {showAddForm ? 'Abbrechen' : 'Neuer Eintrag'}
        </Button>
      </header>
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-sans text-[11px] text-muted-foreground">{count} Einträge</p>
                </div>
              </button>
            );
          },
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="font-sans text-sm text-muted-foreground">
                {entries.length === 0
                  ? 'Noch keine Memory-Einträge. Erstelle deinen ersten Eintrag oben.'
